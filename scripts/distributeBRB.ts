...
const main = async () => {
    const brb = await viem.getContractAt("BRB", "0x51ac8e3b12a9ef342b5d273bc3305c4916cb5c2c");
    const stakedBrbProxy = await viem.getContractAt("StakedBRB", "0x4317a59aF46e1f09809A22A4Ff0Efb06AFb4aADF");
